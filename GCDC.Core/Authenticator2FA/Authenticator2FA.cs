...
namespace GCDC.Core.Authenticator2FA
{
	[DataContract]
	...
	public class UmbracoUserAppAuthenticator : ITwoFactorProvider
	{
		...
		/// </summary>
		public const string Name = Constants._2FAConfiguration.ApplicationName;
		...
		public Task<object> GetSetupDataAsync(Guid userOrMemberKey, string secret)
		{
			...
			SetupCode setupInfo = twoFactorAuthenticator.GenerateSetupCode(Constants._2FAConfiguration.ApplicationName, user.Username, secret, false);
