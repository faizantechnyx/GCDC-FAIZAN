...
namespace GCDC.Web.Controllers.Pages
{
    ...
    {
        public LeadershipController(ILogger<LeadershipController> logger, IBaseControllerFactory factory) : base(logger, factory)
        {
        }
        public override IActionResult Index()
        {
            ...
            {
                string ViewPath = "Leadership.cshtml";
                try
                {
                    
                    return View(Constants.PageViewLocation + ViewPath, CurrentPage as Leadership);
                }
                catch (Exception ex)
                {
